            ...
            <div class="col-md-10 content">
                <div class="panel panel-default">
                    ...
                    <div id="demo" class="collapse">
                        <li style="text-decoration: none;font-size: 3rem" ><a href="#"><span ></span> Course</a></li>
                        <li style="text-decoration: none;font-size: 3rem"><a href="#"><span class="glyphicon "></span> Class</a></li>  
                    </div>
